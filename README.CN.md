...
| 🗑️ **卸载残留清理增强** | 扩展对已审查常用软件卸载后缓存/日志残留的安全清理覆盖，包括 Electron 应用、IDE、Git 客户端、数据库/API 客户端、Kubernetes/容器桌面工具、游戏启动器、同步/备份客户端、搜索工具、密码管理器、PDF 阅读器、邮件客户端、文献管理工具、笔记应用、协作/聊天工具、终端缓存、远程访问/VPN 工具、传输客户端、截图/扫描工具、图像/媒体工具、视频编辑工具、设计工具、Markdown 工具、OEM 支持工具、创作辅助工具、打印工具、外设工具、安全工具和诊断日志 |
