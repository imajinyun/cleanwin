...
REQUIRED_AI_SCHEMAS = frozenset(
    {
        ...
        "cleanwin.registry-privacy-plan.v1",
        "cleanwin.registry-privacy-change.v1",
        "cleanwin.registry-privacy-revert.v1",
        "cleanwin.registry-privacy-plan-validation.v1",
        "cleanwin.appx-removal-plan.v1",
        "cleanwin.appx-removal-change.v1",
        "cleanwin.appx-removal-revert.v1",
        "cleanwin.appx-removal-plan-validation.v1",
        "cleanwin.service-task-disable-plan.v1",
        "cleanwin.service-disable-change.v1",
        "cleanwin.scheduled-task-disable-change.v1",
        "cleanwin.service-task-revert.v1",
        "cleanwin.service-task-disable-plan-validation.v1",
        "cleanwin.rollback-drill-report.v1",
        "cleanwin.rollback-drill-case.v1",
        "cleanwin.rollback-drill-validation.v1",
        "cleanwin.promotion-gate-validation.v1",
        "cleanwin.disable-revert-contract.v1",
        "cleanwin.permanent-delete-denial.v1",
