...
def disable_revert_contract_report() -> dict[str, Any]:
    action_contracts = [
        ...
        },
        {
            ...
            "source_report": "cleanwin.startup-service-inventory.v1",
            "required_snapshots": ["system-restore-point", "service-state"],
            "required_rollback_metadata": ["service_name", "previous_status", "previous_start_type", "restore_command"],
            "required_review_evidence": ["display_name", "publisher", "signature_status", "risk"],
        ...
        },
        {
            ...
            "source_report": "cleanwin.startup-service-inventory.v1",
            "required_snapshots": ["system-restore-point", "scheduled-task-state"],
            "required_rollback_metadata": ["task_name", "previous_state", "task_xml_or_export_ref", "restore_command"],
            "required_review_evidence": ["task_to_run", "publisher", "target_exists", "risk"],
