...
def rule_quality_dashboard_report() -> dict[str, Any]:
    ...
    return {
        ...
        "external_import_quality": {
            "schema": "cleanwin.external-rule-quality-dashboard.v1",
            "supported_sources": ["translated-winapp2", "translated-cleanerml"],
            ...
            "tracked_counts": [
                ...
                "active_marker_missing_count",
                "sensitive_exclusion_missing_count",
            ...
            "required_blockers": [
                ...
                "active-marker-review-required",
                "sensitive-exclusion-review-required",
                "dangerous-path-review-required",
                "unsupported-semantics-review-required",
            ],
            "promotion_validator_gate": "external-rule-to-reviewed-rule-pack",
        },
        "packs": pack_rows,
