...
identity check reference、sensitive exclusions、rule quality gate、recycle mode
和 confirmation phrase。Browser cache promotion gate 和 preset plan template
都会要求同一组 readiness evidence。该报告保持 `execution_enabled=false`，不会
运行清理。
