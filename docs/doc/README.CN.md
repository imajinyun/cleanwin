...
| `app-leftovers` | 常用软件卸载后的缓存/日志残留 | 覆盖 Slack、经典/新版 Teams、Discord、Zoom、Skype、Webex、VS Code、JetBrains/DataGrip 日志、Docker Desktop 日志、Postman、Notion、Figma、OBS Studio、Spotify、Adobe Creative Cloud、Office telemetry、游戏启动器、GPU shader cache、Telegram、Signal、WhatsApp、Cursor、Android Studio、VirtualBox 日志、VLC artwork cache、1Password 日志、GitHub Desktop、Obsidian、Unity Hub、Unreal/EA/GOG/Ubisoft 启动器缓存、Dropbox 日志、OneDrive/Google Drive/iCloud 诊断日志、Todoist、Linear、Canva、PowerShell startup cache、Windows Terminal diagnostics、Snagit/Camtasia 日志、远程访问和 VPN 诊断日志、Wireshark/FileZilla/WinSCP 状态或日志、calibre cache、qBittorrent 日志、Git 客户端诊断日志、Kubernetes/容器桌面工具诊断日志、数据库/API 客户端诊断日志、图像/媒体工具缓存、设计工具缓存、Markdown 工具渲染缓存、打印工具日志、PowerToys 日志、Logitech G HUB 日志、Corsair iCUE 日志、Razer Synapse 日志等已审查残留；若仍检测到活动安装标记则跳过，并支持 `app-*`、package 版本目录、IDE 版本目录、`*.exe` 等带版本目录/文件名的通配安装标记 |
